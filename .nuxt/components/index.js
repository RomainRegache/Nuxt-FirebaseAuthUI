export const DatePickerRange = () => import('../..\\components\\DatePickerRange.vue' /* webpackChunkName: "components/date-picker-range" */).then(c => wrapFunctional(c.default || c))
export const DialogAddGame = () => import('../..\\components\\DialogAddGame.vue' /* webpackChunkName: "components/dialog-add-game" */).then(c => wrapFunctional(c.default || c))
